...
<x-guest-layout>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="bg-green-700 px-6 py-4 text-center">
            <h2 class="text-2xl font-bold text-white">ثبت‌نام خیریه</h2>
            <div class="text-center mt-3 text-sm text-white/80 bg-white/20 rounded-lg p-2">
                <i class="fas fa-info-circle ml-1"></i>
                 پس از ثبت‌نام، اطلاعات خیریه توسط مدیریت بررسی و تأیید خواهد شد
            </div>
        </div>

            <!-- فرم -->
        <form method="POST" action="{{ route('register.charity.post') }}" enctype="multipart/form-data" class="p-6 space-y-4">
            @csrf
            @if ($errors->any())
                <div style="background: #fecaca; border: 1px solid #ef4444; color: #991b1b; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                    <ul>
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" 
                    ...
                    placeholder= "خیریه خورشید" required>
            ...
            <!-- نام مدیرعامل -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">نام کامل مالک خیریه *</label>
                <input type="text" name="manager_name" value="{{ old('manager_name') }}" 
                    class="w-full border border-gray-300 rounded-lg p-3" required>
                @error('manager_name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            ...
            <!-- شناسه ملی -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">شناسه ملی (۱۱ رقم) *</label>
                <input type="text" name="national_id" value="{{ old('national_id') }}" 
                    class="w-full border border-gray-300 rounded-lg p-3" 
                    placeholder="۱۲۳۴۵۶۷۸۹۰۱" required>
            ...
            <!-- شماره پروانه فعالیت -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">شماره پروانه فعالیت *</label>
            ...
            <!-- تصویر پروانه فعالیت -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">تصویر پروانه فعالیت *</label>
                <input type="file" name="license_image" accept="image/*" required>
                @error('license_image') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>


            <!-- تصویر کارت ملی مدیرعامل -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">تصویر کارت ملی مدیرعامل *</label>
                <input type="file" name="national_card_image" accept="image/*" required>
                @error('national_card_image') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>


            <!-- شماره حساب بانکی -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">شماره حساب بانکی *</label>
            ...
            <!-- کد شبا -->
            <div>
                <label class="block text-gray-700 font-bold mb-2">کد شبا *</label>
                <input type="text" name="iban" value="{{ old('iban') }}" 
                class="w-full border border-gray-300 rounded-lg p-3" 
                placeholder="IR123456789012345678901234" required>
        ...
        <div class="border-t border-gray-200 px-6 py-4 text-center bg-gray-50">
            ...
            <p class="text-gray-500 text-sm mt-2">
                <a href="{{ route('register.donor') }}" class="text-green-600 hover:underline">
                    ثبت‌نام خیر
                </a>
            </p>
        </div>
