<x-guest-layout>
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden p-6">
        ...
        <div>
            <p class="text-gray-700 text-center font-bold text-lg mb-4">تأیید شماره همراه</p>
            <p class="text-gray-500 text-center text-sm mb-4">لطفاً شماره موبایل خود را برای تکمیل ثبت‌نام وارد کنید</p>
            
            <label class="block text-gray-500 mb-2">شماره همراه (۱۱ رقم) *</label>
    ...
    <script>
        ...
        verifyBtn.addEventListener('click', function() {
            ...
            verifyBtn.textContent = 'در حال انتقال...';
            ...
            .then(data => {
                if (data.success) {
                    alertArea.innerHTML = '<div class="bg-green-100 text-green-700 p-3 rounded mb-4"> ثبت‌نام کامل شد. در حال انتقال به داشبورد...</div>';
                    setTimeout(() => {
                        window.location.href = data.redirect;
                    }, 800);
                } else {
                    verifyBtn.disabled = false;
                    verifyBtn.textContent = 'تأیید ';
